...
require_once(__DIR__ . "/../src/Iiterator.php");
require_once("Grammar_rule_gen.php");

class Grammar_rule_gen_container extends \Cheope_ppp_ns\src\Container
{
...
class Grammar_rule_gens_iterator extends \Cheope_ppp_ns\src\Iiterator
{
