...
$phpArraysRule0=new \Cheope_ppp_ns\src\Lex_rule("regola0");
$phpArraysRule1=new \Cheope_ppp_ns\src\Lex_rule("regola1");
$phpArraysRule2=new \Cheope_ppp_ns\src\Lex_rule("regola2");
$phpArraysRule3=new \Cheope_ppp_ns\src\Lex_rule("regola3");
$phpArraysRule4=new \Cheope_ppp_ns\src\Lex_rule("regola4");
$phpArraysRule5=new \Cheope_ppp_ns\src\Lex_rule("regola5");
$phpArraysRule6=new \Cheope_ppp_ns\src\Lex_rule("regola6");
$phpArraysRule7=new \Cheope_ppp_ns\src\Lex_rule("regola7");
$phpArraysRule8=new \Cheope_ppp_ns\src\Lex_rule("regola8");
$phpArraysRule9=new \Cheope_ppp_ns\src\Lex_rule("regola9");
$phpArraysRule10=new \Cheope_ppp_ns\src\Lex_rule("regola10");

$phpArraysRule0->setRegexp("/^[Aa]rray/i");
$phpArraysRule0->setTokenType(\Cheope_ppp_ns\src\Token::TYPE_RESERVED_WORD);
$phpArraysRule0->setTokenVal(PHP_ARRAYS_TOKEN_VAL_ARRAY);

$phpArraysRule1->setRegexp("/[A-Za-z][A-Za-z_0..9]*/i");
$phpArraysRule1->setTokenType(\Cheope_ppp_ns\src\Token::TYPE_RESERVED_WORD);
$phpArraysRule1->setTokenVal(PHP_ARRAYS_TOKEN_VAL_FUN_HEAD);

$phpArraysRule2->setRegexp("/^=>/i");
$phpArraysRule2->setTokenType(\Cheope_ppp_ns\src\Token::TYPE_SPECIAL_ITEM);
$phpArraysRule2->setTokenVal(PHP_ARRAYS_TOKEN_VAL_ARROW);

$phpArraysRule3->setRegexp("/^\(/i");
$phpArraysRule3->setTokenType(\Cheope_ppp_ns\src\Token::TYPE_SPECIAL_ITEM);
$phpArraysRule3->setTokenVal(PHP_ARRAYS_TOKEN_VAL_OPEN_PAR);

$phpArraysRule4->setRegexp("/^\)/i");
$phpArraysRule4->setTokenType(\Cheope_ppp_ns\src\Token::TYPE_SPECIAL_ITEM);
$phpArraysRule4->setTokenVal(PHP_ARRAYS_TOKEN_VAL_CLOSE_PAR);

$phpArraysRule5->setRegexp("/^,/i");
$phpArraysRule5->setTokenType(\Cheope_ppp_ns\src\Token::TYPE_SPECIAL_ITEM);
$phpArraysRule5->setTokenVal(PHP_ARRAYS_TOKEN_VAL_VIRGOLA);

$phpArraysRule6->setRegexp("/^[\s]+/i");
$phpArraysRule6->setTokenType(\Cheope_ppp_ns\src\Token::TYPE_DELIM);
$phpArraysRule6->setTokenVal(PHP_ARRAYS_TOKEN_VAL_WS);

$phpArraysRule7->setRegexp("/^'(?:[^'\\\\]|(?:\\\\\\\\)|(?:\\\\\\\\)*\\\\.{1})*'/i");
$phpArraysRule7->setTokenType(\Cheope_ppp_ns\src\Token::TYPE_LEXICAL_ELEMENT);
$phpArraysRule7->setTokenVal(PHP_ARRAYS_TOKEN_VAL_ITEM1);

$phpArraysRule8->setRegexp("/^\"(?:[^\"\\\\]|(?:\\\\\\\\)|(?:\\\\\\\\)*\\\\.{1})*\"/i");
$phpArraysRule8->setTokenType(\Cheope_ppp_ns\src\Token::TYPE_LEXICAL_ELEMENT);
$phpArraysRule8->setTokenVal(PHP_ARRAYS_TOKEN_VAL_ITEM2);

$phpArraysRule9->setRegexp("/^[0-9][0-9]*/i");
$phpArraysRule9->setTokenType(\Cheope_ppp_ns\src\Token::TYPE_LEXICAL_ELEMENT);
$phpArraysRule9->setTokenVal(PHP_ARRAYS_TOKEN_VAL_NUM);

$phpArraysRule10->setRegexp("/^[A-Z@_]+/");
$phpArraysRule10->setTokenType(\Cheope_ppp_ns\src\Token::TYPE_LEXICAL_ELEMENT);
...
$phpArraysDefGrRules=new \Cheope_ppp_ns\src\Parser_grammar_rules_container(PHP_ARRAYS_PARSER_GRAMMAR_RULE_CONTAINER_1);
...
$phpArraysRule1->setTokenType(\Cheope_ppp_ns\src\Token::TYPE_SPECIAL_ITEM);
...
$phpArraysRule5->setTokenType(\Cheope_ppp_ns\src\Token::TYPE_DELIM);
$phpArraysRule5->setTokenVal(PHP_ARRAYS_TOKEN_VAL_WS);

$phpArraysRule6->setRegexp("/^'(?:[^'\\\\]|(?:\\\\\\\\)|(?:\\\\\\\\)*\\\\.{1})*'/i");
$phpArraysRule6->setTokenType(\Cheope_ppp_ns\src\Token::TYPE_LEXICAL_ELEMENT);
