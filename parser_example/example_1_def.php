...
$example1Rule0=new \Cheope_ppg_ns\src\Lex_rule("regola0");
$example1Rule1=new \Cheope_ppg_ns\src\Lex_rule("regola1");

$example1Rule0->setRegexp("/^a/");
$example1Rule0->setTokenType(\Cheope_ppg_ns\src\Token::TYPE_LEXICAL_ELEMENT);
$example1Rule0->setTokenVal(EXAMPLE_1_TOKEN_VAL_A);

$example1Rule1->setRegexp("/^b/");
$example1Rule1->setTokenType(\Cheope_ppg_ns\src\Token::TYPE_LEXICAL_ELEMENT);
$example1Rule1->setTokenVal(EXAMPLE_1_TOKEN_VAL_B);

define('EXAMPLE_1_LEX_RULE_CONTAINER_0',"Contenitore_regole_0");

$example1DefRules=new \Cheope_ppg_ns\src\Lex_rules_container(EXAMPLE_1_LEX_RULE_CONTAINER_0);
...
$example1Rule0_1=new \Cheope_ppg_ns\src\Lex_rule("regola0");
$example1Rule1_1=new \Cheope_ppg_ns\src\Lex_rule("regola1");

$example1Rule0_1->setRegexp("/^b/");
$example1Rule0_1->setTokenType(\Cheope_ppg_ns\src\Token::TYPE_LEXICAL_ELEMENT);
$example1Rule0_1->setTokenVal(EXAMPLE_1_TOKEN_VAL_B);

$example1Rule1_1->setRegexp("/^c/");
$example1Rule1_1->setTokenType(\Cheope_ppg_ns\src\Token::TYPE_LEXICAL_ELEMENT);
$example1Rule1_1->setTokenVal(EXAMPLE_1_TOKEN_VAL_C);

define('EXAMPLE_1_LEX_RULE_CONTAINER_1',"Contenitore_regole_1");

$example1DefRules1=new \Cheope_ppg_ns\src\Lex_rules_container(EXAMPLE_1_LEX_RULE_CONTAINER_1);
